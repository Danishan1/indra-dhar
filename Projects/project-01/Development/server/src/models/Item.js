...
const historySchema = new Schema({
  ...
  action: { type: String, enum: ['CREATE','MOVE_FORWARD','RETURN','BULK_ADD','BULK_REMOVE','RETURN_ACCEPTED','RETURN_REJECTED'] },
  note: { type: String },
...
const itemSchema = new Schema({
  ...
  status: { type: String, enum: ['IN_PROGRESS','RETURNED','COMPLETED'], default: 'IN_PROGRESS' },
