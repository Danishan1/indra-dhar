...
export default function UpdatePage() {
  return (
    <CrudFormPage
      ...
      title="Product"
      fields={[
        { key: "name", label: "Product Name", type: FORM_TYPE.TEXT },
        { key: "sku", label: "SKU", type: FORM_TYPE.TEXT },
        { key: "description", label: "Description", type: FORM_TYPE.TEXTAREA},
        { key: "default_batch_size", label: "Default Batch Size", type: FORM_TYPE.TEXT },
